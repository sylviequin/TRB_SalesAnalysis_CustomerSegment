...
**The turn.**: That demand was pulled forward, not created sustainably. Once the pandemic-driven buying wave passed, the global bicycle industry hit a well-documented correction through 2023–2024: dealer inventories ballooned (US wholesaler stock reached 181% of pre-pandemic levels by early 2023), discounting deepened industry-wide (average discounts rose from roughly 2.8% to 9.2%), and the inventory-to-sales ratio climbed from 2.9:1 to 4.1:1 by mid-2024.
